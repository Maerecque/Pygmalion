...
if __name__ == "__main__":
    ...
    if pcd is not None:
        ...
        mesh = repair_point_cloud_module(
            plane_pointcloud,
            visualize=True,
            kdtree_max_nn=100,
            depth=13,
    ...
    # # When the point cloud alterations are done, the point cloud is saved as a PLY file or no LAS file is given, this part will start. # noqa: E501
    # print("\n Starting PLY module")
